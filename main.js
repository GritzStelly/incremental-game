...
function debug(){
  //function created solely for visual and real-time debugging.  prints all variables plus any subsequent information
  /*
  var obj = {a: 1, b: 2, c: 3};
...
// "obj.c = 3"
  ...
  var statement = [];
  var variables = [clicks, research, upgrades, devices, buildings, timer, hour];
  for (var variable in variables){
    if (typeof variable != object){
      //for non-objects
      statement.push(variable);
    }
    else{
      //for objects
    }
